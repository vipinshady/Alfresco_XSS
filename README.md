...
2. Cross-site scripting (XSS) is triggered in the Alfresco portal as the victim clicks on "view in browser" tab.
...
3. Another example of a phishing page by modifying the content in the HTML page.
